    ...
    <section class="features">
        <div class="container">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; align-items: center; margin-bottom: 3rem;">
                ...
                <div>
                    <img src="../assets/images/audio-monitor.jpg" alt="Démonstration de surveillance audio" style="width: 100%; border-radius: var(--border-radius); box-shadow: var(--box-shadow);">
                </div>
            </div>
